 ...
 */
    ...
    hasColConflictAt: function(colIndex) {
      var sum = 0;
      // For each column, since #col = #row
      // Get the row, and access the colIndex of that row
    ...
    // Major Diagonal - go from top-left to bottom-right
    // --------------------------------------------------------------
    //
    // test if a specific major diagonal on this board contains a conflict
    hasMajorDiagonalConflictAt: function(majorDiagonalColumnIndexAtFirstRow) {
      var boundary = this.get("n");
      var initCol = majorDiagonalColumnIndexAtFirstRow;
      var sum = 0;
    ...
    hasMinorDiagonalConflictAt: function(minorDiagonalColumnIndexAtFirstRow) {
      var boundary = this.get("n");
      var initCol = minorDiagonalColumnIndexAtFirstRow;
      var sum = 0;
